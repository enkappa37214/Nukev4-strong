...
CONFIG = {
    ...
    # 2. Linkage Kinematics (Linear Progressive)
    "LEV_RATIO_START": 2.90,
    "LEV_RATIO_COEFF": 0.00816,

    # 3. Spring Hardware limits
    "SPRING_MIN": 390,
    "SPRING_MAX": 430,
    ...
    # 5. Fork Baseline (Selva V calibrated @ 72 kg)
    "BASE_FORK_PSI": 63.0,
    "FORK_PSI_PER_KG": 0.85,
    "SAG_PITCH_GAIN": 0.75,

    # 6. Negative Spring Compensation
    "NEG_SPRING_THRESHOLD": 70,
    "NEG_SPRING_GAIN": 0.6,

    # 7. Brake Support Logic
